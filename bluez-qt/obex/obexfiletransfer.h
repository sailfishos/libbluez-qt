...
#ifndef OBEXFILETRANSFER_H_1377149902
#define OBEXFILETRANSFER_H_1377149902
...
public:
    ObexFileTransferInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
