...
#ifndef OBEXSESSION_H_1377130626
#define OBEXSESSION_H_1377130626
...
public:
    ObexSessionInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
