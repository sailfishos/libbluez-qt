...
{
        m_client = new ObexClientInterface("org.bluez.obex.client", "/", QDBusConnection::sessionBus(), this);
...
void ObexFtp::finishedConnecting(QDBusPendingCallWatcher* call)
{
        ...
        m_session = new OrgBluezObexSessionInterface("org.bluez.obex.client", sessionPath.path(), QDBusConnection::sessionBus());
        ...
        m_ftp = new OrgBluezObexFileTransferInterface("org.bluez.obex.client",
...
{
        ObexTransferInterface transfer("org.bluez.obex.client",path.path(),QDBusConnection::sessionBus());
